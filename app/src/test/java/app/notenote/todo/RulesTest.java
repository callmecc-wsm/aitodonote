...
public class RulesTest {
 ...
 @Test public void scheduledResearchNeedsDueDateAndRemainingBudget(){assertFalse(Rules.reviewEligible("think",false,1,0,200,false,1,"",100));assertTrue(Rules.reviewEligible("think",false,1,0,200,false,1,"",200));assertFalse(Rules.reviewEligible("think",false,1,0,200,false,3,"",200));assertFalse(Rules.reviewEligible("think",false,1,0,200,true,1,"",200));assertFalse(Rules.reviewEligible("think",false,1,0,200,false,1,"failed",200));}
 @Test public void sourceLinksRejectCredentialsAndExecutableSchemes(){assertTrue(Rules.safeLink("https://docs.example.com/page?a=1"));assertFalse(Rules.safeLink("https://key@example.com/page"));assertFalse(Rules.safeLink("javascript:alert(1)"));assertFalse(Rules.safeLink("http://example.com"));}
}
